...
const MobilePlanCard = ({
  ...
  return (
    ...
    >
      ...
      {/* 이미지 */}
      <div
        className={`${cardStyles.image} relative rounded-[16px] overflow-hidden bg-gray-100 flex items-center justify-center flex-shrink-0`}
      >
        {!imagePath || imageError ? (
          ...
          <>
            <div
              className="absolute inset-0 flex items-center justify-center bg-gray-100 text-gray-400 transition-opacity duration-300"
              style={{
