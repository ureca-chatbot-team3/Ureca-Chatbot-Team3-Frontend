...
export default function ChatbotToast({ visible }) {
  return (
    <div
      className={`
        absolute bottom-[80px] left-1/2 -translate-x-1/2 w-[323px] h-[63px]
    ...
    >
      ...
      <span className="text-[var(--color-white)] body-medium font-500 leading-[35px]">
        주민등록번호, 전화번호 등 <br/>개인정보를 입력하지 마세요.
      </span>
    </div>
  );
}
