...
const AIYopleming = () => {
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="relative max-w-full w-full h-full overflow-hidden rounded-2xl">
        <img
        ...
        >
          <div className="max-w-[300px] min-w-[100px] w-full overflow-hidden self-end">
            <img src={Yopleming} alt="AI 챗봇 요플밍" className="w-full h-full object-contain" />
          </div>
          <div className="relative bg-white border border-pink-700 p-lg rounded-lg max-w-full w-full h-fit">
            <p className="text-gray-800 body-large font-300">
              🦩 안녕하세요! <br />
              저는 요플랜의 AI 요금제 추천 챗봇 <span className="text-pink-700">요플밍</span>{' '}
              이에요. <br />
              <br />
              ✔️ 통화량, 데이터 사용량, 예산에 따라 <br />
              ✔️ 여러분에게 꼭 맞는 요금제를 추천해드려요. 복잡한 요금제 비교는 이제 그만! <br />
              <br />
              저랑 대화하면서 쉽고 빠르게 해결하세요.
            </p>
            <div
              className="absolute -left-[18px] bottom-[79px] w-0 h-0 border-t-[10px] border-b-[10px]
            border-r-[18px] border-t-transparent border-b-transparent border-r-pink-700 z-0"
            />

            <div
              className="absolute -left-4 bottom-20 w-0 h-0 
